...
@section('content')
    <section id="main-content">
        <section class="wrapper">
            <section class="panel">
                ...
                <div class="datetimepicker datetimepicker-dropdown-bottom-left dropdown-menu"
                     style="left: 0px; z-index: 10;">
                    <div class="datetimepicker-minutes" style="display: none;">
                        <table class=" table-condensed">
                            <thead>
                            <tr>
                                <th class="prev" style="visibility: visible;"><i class="fa fa-angle-left"></i></th>
                                <th colspan="5" class="switch">15 June 2012</th>
                                <th class="next" style="visibility: visible;"><i class="fa fa-angle-right"></i></th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
                                <td colspan="7"><span class="minute">14:00</span><span class="minute">14:05</span><span
                                            class="minute">14:10</span><span class="minute">14:15</span><span
                                            class="minute">14:20</span><span class="minute">14:25</span><span
                                            class="minute">14:30</span><span class="minute">14:35</span><span
                                            class="minute">14:40</span><span class="minute active">14:45</span><span
    ...
    <script type="text/javascript"
            src="{{Request::root()}}/assets/bootstrap-datepicker/js/bootstrap-datepicker.js"></script>
    ...
    <script type="text/javascript"
            src="{{Request::root()}}/assets/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.tr.js"></script>
    <script type="text/javascript">
        ...
        $('.form_datetime-componentStart').datetimepicker({
            ...
            language: 'tr',
                    ...
                    $('.form_datetime-componentEnd').datetimepicker("destroy").datetimepicker('setStartDate', startDate);
        });

        $('.form_datetime-componentEnd').datetimepicker({
                    weekStart: 1,
                    language: 'tr',
                    format: "dd MM yyyy DD hh:ii",
                    startDate: startDate,
                ...
                .on('changeDate', function (selected) {
                    ...
                    $('.form_datetime-componentStart').datetimepicker("destroy").datetimepicker('setEndDate', FromEndDate);
                });
